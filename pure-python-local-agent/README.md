...
| `search_internet` | Web search (Tavily Search API) |
...
`TAVILY_API_KEY` powers the `search_internet` tool. A free key is available from [tavily.com](https://app.tavily.com/) and includes 1,000 searches a month. The other tools work without it.
